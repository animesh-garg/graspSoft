...
QMAKE    = /usr/bin/qmake
matvtk_guiserver.xcodeproj/project.pbxproj: matvtk_guiserver.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o matvtk_guiserver.xcodeproj/project.pbxproj matvtk_guiserver.pro
