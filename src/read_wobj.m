function OBJ=read_wobj(fullfilename, enable_mesh_cache)
...
% enable_mesh_cache = 1 or 0
% Edited to allow for mesh cashing Animesh Garg (July 2013)
...
if ~exist('enable_mesh_cache','var')
    enable_mesh_cache = 1;
end
cachepath = [fullfilename, '.meshcache-wOBJ'];
...
%enable mesh caching
if(verbose),disp('Writing to cache'); end
if enable_mesh_cache
    save( cachepath, 'OBJ', '-mat' );
end
